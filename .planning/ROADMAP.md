...
Plans:
- [x] 01-01-PLAN.md — Monorepo foundation, Docker Compose stack, Prisma schema + RLS scaffolding
- [x] 01-02-PLAN.md — Identity & access: customer auth, admin MFA, RBAC, session management
- [x] 01-03-PLAN.md — Storefront experience: UI tokens, catalog browsing, product detail, contact form
- [x] 01-04-PLAN.md — Dev environment gap closure: compose override + MFA_ENCRYPTION_KEY
- [ ] 01-05-PLAN.md — Upload & quote pipeline: presigned upload, scan worker, geometry analysis, pricing engine, quote-to-order
- [ ] 01-06-PLAN.md — Commerce checkout & payments: Stripe + PayPal, webhooks, order records, PDF receipts, order portal
- [ ] 01-07-PLAN.md — Admin operations dashboard: KPIs, order/quote queues, product CRUD, audit log explorer
- [ ] 01-08-PLAN.md — Notifications & email: Microsoft Graph + Gmail adapters, templates, Discord DM integration
- [ ] 01-09-PLAN.md — RLS hardening: entity registry, negative-case tests, tenant context propagation, contact rate limit, session rotation
...
|-------|----------------|--------|-----------|
| 1. PLAground Commerce | 4/9 | In progress | - |
...
### Phase 999.1: Repair dev startup stack and frontend preview path (BACKLOG)
